...
advanced_expl_div = $('<div id="permdialog_advanced_explantion_text"><strong>For more permissions or advanced settings, click Advanced.</strong> <br> NOTE: If a permission is indicated as both ALLOWED and DENIED, the permission will be denied.</div>')
...
$('#adv_perm_inheritance').change(function(){
    ...
    if( $('#adv_perm_inheritance').prop('checked')) {
        ...
        $(`<div id="add_remove_cancel" title="Security">
            ...
            - Click <strong>Add</strong> to allow inherited permissions to be edited directly.<br/><br/>
