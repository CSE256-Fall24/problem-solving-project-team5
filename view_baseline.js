...
advanced_expl_div = $('<div id="permdialog_advanced_explantion_text">For special permissions or advanced settings, click Advanced. <br> NOTE: If a permission is indicated as both ALLOWED and DENIED, the permission will be denied.</div>')
